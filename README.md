...
2. Extract the contents and copy the `neo_quicksetting.koplugin` folder into your device's KOReader plugins directory:
   - `koreader/plugins/`
3. **Important:** Inside the downloaded package, you will find a file named `neo.svg`. You **must** copy this file and place it inside KOReader's core icons directory:
   - `koreader/icons/neo.svg`
4. Restart KOReader.
...
* **[renandeivison](https://github.com/renandeivison/quicksettings)**- For the amazing UI layout, creative icons, and structural codebase.
